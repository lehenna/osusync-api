...
import { ReplaysRepository } from '../repositories/replays';

export class ReplayControllers {
    static async create(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const currentRepository = ReplaysRepository.getInstance()
